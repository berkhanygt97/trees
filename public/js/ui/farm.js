  ...
  return listPanel(ctx, (w) => {
    ...
    return `
      ...
      <div class="shop-list">
        ...
        ${row({ icon: '🧑‍🌾', name: `Staff (${(w.staff || []).length})`, desc: 'Rename your workers, pick what they plant or sell, or let them go. Hire more at the Job Centre in town.', buttons: btn('STAFF', 'staff') })}
